      ...
      <div className="flex flex-col items-end my-12">
        <div className="flex text-gray-700">
          ...
          <div className="flex h-12 font-medium rounded-full bg-gray-200">
            ...
            <div className="w-12 md:flex justify-center items-center hidden  cursor-pointer leading-5 transition duration-150 ease-in  rounded-full bg-red-600 text-white ">
              2
            </div>
            <div className="w-12 md:flex justify-center items-center hidden  cursor-pointer leading-5 transition duration-150 ease-in  rounded-full  ">
              3
